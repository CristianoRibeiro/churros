  <div class="container"">
      ...
      <div class="starter-template">
        <h1>A melhor maneira de encontrar churros 😍</h1>
        <p class="lead">Através de uma busca relevante de onde achar churros. <br> Podemos trazer os melhores resultados de churros proximos de você.<br><br></p>

         <form class="contact-form">

              <div class="input-group">
                  <label></label>
                  <input type="text" class="form-control" placeholder="Pesquise pelo CEP, cidade ou estabelecimento">
                  <span class="input-group-btn">
                      <button type="button" class="btn btn-primary btn-block">Search <i class="ion-android-arrow-forward"></i></button>
                  </span>
             </div>
        ...
        <div class="inner">
            <a href="#one" class="btn btn-primary-outline btn-xl page-scroll wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Conhecer mais sobre isso...</a>
        </div>
    ...
    <div class="container wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
        <div class="row">
            <div class="col-lg-4 col-md-4 text-xs-center">
                <div class="feature">
                    <i class="icon-lg ion-ios-grid-view-outline wow fadeIn" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;"></i>
            ...
            <div class="col-lg-4 col-md-4 text-xs-center">
                <div class="feature">
                    <i class="icon-lg ion-social-sass wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"></i>
            ...
            <div class="col-lg-4 col-md-4 text-xs-center">
                <div class="feature">
                    <i class="icon-lg ion-social-css3-outline wow fadeIn" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;"></i>
                ...
                <div class="col-md-6 col-xs-12 text-xs-center">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <a href="#alertModal" data-toggle="modal" data-target="#alertModal"><i class="icon-lg ion-ios-cloud-download-outline wow fadeIn" style="visibility: hidden; animation-name: none;"></i></a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <i class="icon-lg ion-ios-pie-outline wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <i class="icon-lg ion-ios-star-outline wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <i class="icon-lg ion-ios-heart-outline wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <i class="icon-lg ion-ios-pulse wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <i class="icon-lg ion-ios-refresh-outline wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                            <i class="icon-lg ion-ios-gear-outline wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                        <div class="col-lg-3 col-md-3 col-xs-6 text-xs-center">
                                <i class="icon-lg ion-ios-timer-outline wow fadeIn text-primary" style="visibility: hidden; animation-name: none;"></i>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 clearfix">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="card text-normal">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="text-truncate"><code>text-truncate</code> some longer text that won't wrap and will truncate with ellipsis at the end.</li>
                        </ul>
                        ...
                        Here's a handy <a href="http://upgrade-bootstrap.bootply.com/">Bootstrap 3 to 4 upgrade tool</a> to convert your code!
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xs-12">
